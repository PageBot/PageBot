...
def makeThesis():
    ...
    doc.newStyle(name='h1', fontSize=32, textFill=(1, 0, 0), leading=40, prefix='\n',postfix='\n')
    doc.newStyle(name='h2', fontSize=24, textFill=(0, 0.5, 1), leading=30, prefix='\n', postfix='\n')
    doc.newStyle(name='h3', fontSize=24, textFill=(1, 0, 1), leading=30, prefix='\n', postfix='\n')
