...
content = {
        ...
        'entertainment_section':['Theater', 'Broadway', 'Show', 'Movie',
            ...
            'Featured films', 'Story', 'Don’t miss',
        ...
        'entertainment_gossip':[
            ...
            'A day with <#name#>?',
            'Meet <#name#>',
            '<#names_first_female#>’s next movie?',
            '<#names_first_female#> playes <#names_first_female#>',
            'What said <#names_first_female#>?',
            'Where are they now?',
            '<#name_male#> and <#name_female#> to divorce',
            '<#name_male#> Says Yes to <#names_first_female#>’s invite',
            'Are the phrases “<#entertainment_shortheadline#>” / “<#entertainment_shortheadline#>” oxymorons?',
        ],
        'entertainment_shows':[
            'The <#name#> Show',
            'The <#name#> Late Show',
