...
content = {
    ...
    'island': [
            ...
            'Bornholm', 'Fanø', 'Rømø', 'Lolland', 'Barbados', 'Bermuda', 'Bonaire', 'British Virgin Islands', 'Curaçao',
            ...
            'Timor-Lesté', 'Kiribati', 'Trinidad', 'Tobago', 'Maldives', 'Marshall Island', 'Vanuatu',
            ],
    'mountain': [
            'Ahaggar Mountains (3,003 m)', 'Auasberge (2,485 m)','Aïr Mountains (2,022 m)','Chappal Waddi (2,419 m)',
