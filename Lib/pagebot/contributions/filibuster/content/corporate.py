...
content = {
    ...
    'business_name': [
        ...
        '<#air_carrier#> <#business_type#>',
        '<#car_brand#> <#business_type#>',
        '<#p_eurobank_px#> <#business_type#>',
        '<#p_co_newssrcname#> <#business_type#>',
        '<#p_co_mediaprefix#> <#business_type#>',
        '<#p_co_mediaprefix#> <#p_co_mediasuffix#> <#business_type#>',
        '<#p_co_mediasuffix#> <#p_co_mediaprefix#> <#business_type#>',
        '<#p_co_mediasuffix#> <#business_type#>',
        '<#p_technologies#> <#business_type#>',
        '<#p_co_creative#> <#business_type#>',
        '<#name_first_last#> <#business_type#>',
        '<#name_first_last#> <#business_type#>',
        '<#names_last#> <#business_type#>',
        '<#names_last#> <#business_type#>',
        '<#names_last#> <#books_section#> <#business_type#>',
        '<#tonic_quack#> <#business_type#>',
        '<#county_US#> <#business_type#>',
        '<#realestate_subject#> <#business_type#>',
        '<#paper_generic_English#> <#business_type#>',
        '<#town_us_px#> <#business_type#>',
        '<#nationality_major#> <#business_type#>',
        '<#politics_euro_nationality#> <#business_type#>',
    ],
