...
content = {
    ...
    'hs_astrology_section': [
        ...
        'The Signs',
        'This is your fate, and there isn’t a damn thing you can do about it!',
    ],
    'hs_bullshit': [
    ...
    'hs_prediction_sx': [
        ...
        ' and don’t be too quick to enter into joint financial ventures.',
        ', you could easily be blamed for something you didn’t do.',
