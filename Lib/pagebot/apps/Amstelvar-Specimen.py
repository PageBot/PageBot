...
def makeDocument():
    ...
    def firstColumnWaterfall(b, fontStyle):
        ...
        newTextBox(s ,parent=page, w=CW2, h=pt(700),font=f, pt=pt(160),nextElement='e2',
            conditions=[Left2Left(),Top2Top(), Overflow2Next()])
        newTextBox(s2 ,parent=page, w=CW2, h=pt(700),font=f, pt=(pt(70)), nextElement='e2',
            conditions=[Left2Left(),Top2Top(), Overflow2Next()])
        doc.solve()
