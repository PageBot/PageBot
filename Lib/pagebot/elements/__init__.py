...
def newPlacer(**kwargs):
    """Placer occupying a space on Page or Template. Is not visible exported documets."""
...
def newGroup(point=None, **kwargs):
    """Create a new group. Note that w and h can also be defined in the style. In case h is omitted,
    a square is drawn."""
