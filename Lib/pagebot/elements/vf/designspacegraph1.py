...
var attractForce = d3.forceManyBody().strength(100).distanceMax(60).distanceMin(20);
var repelForce = d3.forceManyBody().strength(-400).distanceMax(60).distanceMin(20);
