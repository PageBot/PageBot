...
class GlyphDimensions(BaseFontShow): 
    ...
    def __init__(self, f, **kwargs):
        ...
        >>> gs = GlyphDimensions(font1, parent=page, conditions=conditions, padding=40, style=style, context=c)
        ...
        >>> gs = GlyphDimensions(font2, parent=page, conditions=conditions, style=style, padding=40, context=c)
        >>> score = doc.solve()
    ...
    def drawGlyphDimensions(self, view, origin):
        u"""Draw the the indicated glyph(s), with dimensions and other indicator.
        """
        c = self.context
        ox, oy, _ = origin
