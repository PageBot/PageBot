...
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2Center(), Top2TopSide()))
bs = c.newString('Left2Center\nTop2TopSide', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2Center(), Top2TopSide()))
bs = c.newString('Right2Center\nTop2Top', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2Center(), Top2Top()))
bs = c.newString('Left2Center\nTop2Top', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2Center(), Top2Top()))


bs = c.newString('Right2Center\nBottom2BottomSide', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2Center(), Bottom2BottomSide()))
bs = c.newString('Left2Center\nBottom2BottomSide', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2Center(), Bottom2BottomSide()))
bs = c.newString('Right2Center\nBottom2Bottom', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2Center(), Bottom2Bottom()))
bs = c.newString('Left2Center\nBottom2Bottom', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2Center(), Bottom2Bottom()))


bs = c.newString('Left2LeftSide\nBottom2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2LeftSide(), Bottom2Middle()))
bs = c.newString('Left2LeftSide\nTop2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2LeftSide(), Top2Middle()))
bs = c.newString('Left2Left\nBottom2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2Left(), Bottom2Middle()))
bs = c.newString('Left2Left\nTop2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Left2Left(), Top2Middle()))

bs = c.newString('Right2RightSide\nBottom2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2RightSide(), Bottom2Middle()))
bs = c.newString('Right2RightSide\nTop2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2RightSide(), Top2Middle()))
bs = c.newString('Right2Right\nBottom2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P, h=P, padding=G, conditions=(Right2Right(), Bottom2Middle()))
bs = c.newString('Right2Right\nTop2Middle', style=style)
...
bs = c.newString('Left2Center\nBottom2Middle', style=style)
newTextBox(bs, parent=page, fill=0.8, stroke=0, w=P-G, h=P-G, margin=G/2, padding=G, conditions=(Left2Center(), Bottom2Middle()))
