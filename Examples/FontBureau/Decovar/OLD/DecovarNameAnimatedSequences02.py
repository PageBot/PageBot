...
H = S*90
AXIS_FACTOR = 1000
FRAMES = 20 # Number of frames per sequence.
MOVE = FRAMES/80.0
STEP = 1 # 20
    ...
    for axisName1 in axisNames1:  
        for axisName2 in axisNames2:  
            ...
            while angle < 2:
                ...
                location[axisName2] = (minValue2 + a * 0.5 * valueRange2) * AXIS_FACTOR
                locations.append(location) 
                location['changed'] = '%s %s' % (axisName1, axisName2)
                angle += angleStep
    return locations
