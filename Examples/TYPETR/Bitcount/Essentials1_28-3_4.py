...
EXPORT_PATH = '_export/Essentials1_28-3_4.gif'
...
H = 900 # Height of the sample image
...
def drawSample(name1, name2):
    ...
    for frame in range(frames-1):
        if frame < frames/2:
            ...
            fss1 = fss1[:-1]
            fss2 = fss2[:-1]
        drawLayers(fss2, frame, 2, 22*padding, True) # Draw layers on several identical frames, using SIngle or Double.
        drawLayers(fss1, frame, 1, 0, False) # Draw layers on several identical frames, using SIngle or Double.
