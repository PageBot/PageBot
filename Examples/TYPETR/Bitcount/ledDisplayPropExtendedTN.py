...
if __name__ == '__main__':
    ...
    h = 12*PIX
    for n in range(45):
        makeRunningLeds(line1, w, h, w-(1+n)*PIX*speed+9*PIX, 0, speed)
    ...
    for flash in range(6):
        makeFlash(line2, w, h, 7*PIX, 0, color1=(0.3, 0.9, 0), color2=(0.1, 0.3, 0))
           
    context.openTypeFeatures(dict(liga=False, zero=False, onum=False, lnum=False, hwid=False, ss01=False, ss02=False, 
