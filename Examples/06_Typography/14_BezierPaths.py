...
path.rect(0, 0, CW, CW)
path.text('Rect', (TP, TP), style=style)
...
path = PageBotPath(context)
path.rect(0, 0, CW, CW)
path.text('moveBy', (TP, TP), style=style)
context.fill(color(1, 0, 0))
context.drawPath(path, (x, y))
...
path1.text('Difference', (TP, TP), style=style)
path2 = path1.copy()
path2.moveBy((50, 50))
...
path1.text('Union', (TP, TP), style=style)
path2 = path1.copy()
...
path1 = PageBotPath(context)
path1.rect(0, 0, CW*2/3, CW*2/3)
path1.text('Xor', (TP, TP), style=style)
path2 = path1.copy()
path2.moveBy((CW/3, CW/3))
...
path.scale(CW/iw)
path1.text('Trace Image', (TP, TP), style=style)
context.fill(color(1, 0, 0))
...
# Get the path of the image from PageBot resources
context.image(imagePath, p=(x, y), h=CH)
#path1.text('Scale Image', (TP, TP), style=style)
context.drawPath(path, (x, y-10))
context.stroke(0, 0.5)
context.fill(noColor)
context.rect(x, y, CW, CW)
...
path2 = PageBotPath(context)
path2.text('Points', (TP, TP), style=style)
context.stroke(noColor)
context.fill(0)
context.drawPath(path2, (x, y))
...
context.drawPath(path2, (x, y))    
path2 = PageBotPath(context)
path2.text('Rotate 30°', (TP, TP), style=style)
context.stroke(noColor)
context.fill(0)
context.drawPath(path2, (x, y))
...
context.drawPath(path2, (x, y))    
path2 = PageBotPath(context)
path2.text('Skew 30°', (TP, TP), style=style)
context.stroke(noColor)
context.fill(0)
context.drawPath(path2, (x, y))
...
context.drawPath(path2, (x, y))
path = PageBotPath(context)
path.text('Intersections', (TP, TP+G), style=style)
context.fill(0)
context.stroke(noColor)
context.drawPath(path, (x, y))
...
path = PageBotPath(context)
path.text('Point Inside', (TP, TP+G), style=style)
context.fill(0)
context.stroke(noColor)
context.drawPath(path, (x, y))
