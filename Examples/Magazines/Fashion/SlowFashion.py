...
shadow = None #Shadow(offset=(6, -6), blur=10, color=(0.2, 0.2, 0.2, 0.5))
...
def makeCoverTemplate(imagePath, w, h):
    ...
    coverTitleFont = getVariableFont(FONT_PATH, dict(wght=0.9, wdth=0.02))
    coverTitleStyle = dict(font=coverTitleFont.installedName, fontSize=160, shadow=shadow, 
        textFill=textColor, tracking=-3)

    coverSubTitleFont = getVariableFont(FONT_PATH, dict(wght=0.6, wdth=0.02))
    coverSubTitleStyle = dict(font=coverSubTitleFont.installedName, fontSize=80, shadow=shadow, 
    ...
    newTextBox(coversubTitle, parent=coverTemplate, pl=FWidth*0.8, 
    ...
    newText(fs, parent=coverTemplate, conditions=[Bottom2Bottom(), Right2Right()])
