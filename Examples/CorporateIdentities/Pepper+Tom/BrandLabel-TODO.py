...
def makeDocument():
    ...
    newColContainer(4, 0, 2, 4, parent=template1)  # Empty image element, cx, cy, cw, ch
    newCContainer(0, 5, 2, 3, parent=template1)
    # Create linked text boxes. Note the "nextPage" to keep on the same page or to next.
    newColTextBox('', 0, 0, 2, 5, parent=template1, name=flowId1, nextBox=flowId2, nextPage=0, fill=BOX_COLOR)
    # TODO: Convert from here still.
